...
<!-- JQVMap -->
<script src="<?php echo PATH_JS; ?>//AdminLTE-3.0.5/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="<?php echo PATH_JS; ?>//AdminLTE-3.0.5/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
